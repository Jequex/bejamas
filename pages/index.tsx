...
const Home: NextPage = () => {
  ...
  const getData: () => Promise<void> = async () => {
    setLoading(true);
    const data: Data = await axios.get('https://bejamasbackend.herokuapp.com/');
                    ...
                    {cart.map((a, i) => (
                      <div className='row my-4' key={i} style={{height: '100px', width: '100%'}}>
                        ...
                        <div className='col' style={{width: '5rem', height: 'inherit'}}>
                          <Image src={a.image.src} alt={a.image.alt} height='80px' width='100px'
                ...
                <>
                  ...
                  <div className='my-4' style={{display: 'block', position: 'relative'}}>
                    ...
                    <div className='bg-white text-dark text-center'
                         style={{position: 'absolute', bottom: '0px', width: '30%', fontSize: '2vh'}}><strong>Photo of
                      the
                      day</strong></div>
                  </div>
                  <div className='row'>
            ...
            <div className='row'>
              <div className='col-2'>
                ...
                <div className='d-flex flex-column'>
                  <div className='form-group m-1'><input type='checkbox' value='people' name='people'
                                                         onChange={onChangeCheckBoxes}
                                                         checked={checkBoxes.includes('people')}/>People
                  </div>
                  <div className='form-group m-1'><input type='checkbox' value='premium' name='premium'
                                                         onChange={onChangeCheckBoxes}
                                                         checked={checkBoxes.includes('premium')}/>Premium
                  </div>
                  <div className='form-group m-1'><input type='checkbox' value='pets' name='pets'
                                                         onChange={onChangeCheckBoxes}
                                                         checked={checkBoxes.includes('pets')}/>Pets
                  </div>
                  <div className='form-group m-1'><input type='checkbox' value='food' name='food'
                                                         onChange={onChangeCheckBoxes}
                                                         checked={checkBoxes.includes('food')}/>Food
                  </div>
                  <div className='form-group m-1'><input type='checkbox' value='landmarks' name='landmarks'
                                                         onChange={onChangeCheckBoxes}
                                                         checked={checkBoxes.includes('landmarks')}/>Landmarks
                  </div>
                  <div className='form-group m-1'><input type='checkbox' value='cities' name='cities'
                                                         onChange={onChangeCheckBoxes}
                                                         checked={checkBoxes.includes('cities')}/>Cities
                  </div>
                  <div className='form-group m-1'><input type='checkbox' value='nature' name='nature'
                                                         onChange={onChangeCheckBoxes}
                                                         checked={checkBoxes.includes('nature')}/>Nature
                  </div>
                </div>
                <hr/>
                <div className='my-2'><strong>Price Range</strong></div>
                <div className='d-flex flex-column'>
                  <div className='form-group m-1'><input type='radio' name='priceRange' value='<20' onChange={onChange}
                                                         checked={formData.priceRange === '<20'}/>Lower than $20
                  </div>
                  <div className='form-group m-1'><input type='radio' name='priceRange' value='>20&<100'
                                                         onChange={onChange}
                                                         checked={formData.priceRange === '>20&<100'}/>$20 - $100
                  </div>
                  <div className='form-group m-1'><input type='radio' name='priceRange' value='>100&<200'
                                                         onChange={onChange}
                                                         checked={formData.priceRange === '>100&<200'}/>$100 - $200
                  </div>
                  <div className='form-group m-1'><input type='radio' name='priceRange' value='>200' onChange={onChange}
                                                         checked={formData.priceRange === '>200'}/>More than $200
                  </div>
                </div>
              </div>
                    ...
                    <div style={{position: 'relative', textAlign: 'center'}}>
                      ...
                      {a.bestseller && (
                        <div className='bg-white text-dark'
                             style={{position: 'absolute', top: '0px', width: '50%'}}>Best
                          Seller</div>)}
